                                    ...
                                    <tbody>
                                        ...
                                        if (mysqli_num_rows($result) > 0) {
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                echo "<td><a href='#'><span class='list-name'>" . $row['firstname'] ." " . $row['lastname']."</span></a></td>";
                                                echo "<td>" . $row['phone'] . "</td>";
                                                echo "<td>" . $row['email'] . "</td>";
                                                
                                                
                                              
                                                echo "<td><span class='badge badge-success'><i class='far fa-edit' href='user-edit.php'></i></span>
